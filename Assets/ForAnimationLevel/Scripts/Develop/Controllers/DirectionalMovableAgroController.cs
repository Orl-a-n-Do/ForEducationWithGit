...
public class DirectionalMovableAgroController : Controller
{
    ...
    public DirectionalMovableAgroController(IDirectionalMoveable movable,
        Transform target, 
        float agroRange, 
    ...
    protected override void UpdateLogic(float deltaTime)
    {
       _idleTimer -= Time.deltaTime;
        ...
        if (NavMeshUtils.TryGetPass(_movable.Position, _target.position, _queryFilter, _pathToTarget))
        {
                ...
                && IdleTimerIsUp())
            {
                ...
                _movable.SetMoveDirection(_pathToTarget.corners[TargetCornerIndex] - _pathToTarget.corners[StartCornerIndex]);//Ќаправление от нулевой точки пути к первой точке;
                return;
            }
        }
